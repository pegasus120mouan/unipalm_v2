...
FROM commandes 
WHERE DATE(date_commande) = CURRENT_DATE - INTERVAL 1 DAY 
AND statut = 'Livré'");
...
WHERE
    c.date_commande = CURRENT_DATE - INTERVAL 1 DAY
    AND u.role = 'clients'
GROUP BY
    u.id, b.nom;
";
...
WHERE 
    DATE(commandes.date_commande) = CURRENT_DATE - INTERVAL 1 DAY 
