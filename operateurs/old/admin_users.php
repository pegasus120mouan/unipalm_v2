...
?>
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-client">
                ...
                <td><?=$admin['login']?></td>
                <td>
                <a href="admin_users_profile.php?id=<?=$admin['id']?>" class="edit"><img src="../pages/dossier_avatars/<?php echo $admin['avatar']; ?>" alt="Logo" width="50" height="50"> </a>
                 </td>
                    <td class="actions">
                        <a href="admin_users_profile.php?id=<?=$admin['id']?>" class="edit"><i class="fas fa-pen fa-xs" style="font-size:24px;color:blue"></i></a>
                        <a href="admin_users_profile.php?id=<?=$admin['id']?>" class="trash"><i class="fas fa-trash fa-xs" style="font-size:24px;color:red"></i></a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
