    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><?php echo $vueClient['boutique_nom']; ?></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary card-outline">
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle" src="../dossiers_images/<?php echo $vueClient['utilisateur_avatar']; ?> ">
            ...
            <h3 class="profile-username text-center">
              <form action="traitement_images.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id" value="<?php echo $vueClient['utilisateur_id']; ?>">
            ...
            <p class="text-muted text-center">Parfumerie</p>
            ...
            <ul class="list-group list-group-unbordered mb-3">
              ...
              <li class="list-group-item">
                <b>Nom boutique</b> <a class="float-right"><?php echo $vueClient['boutique_nom']; ?></a>
              </li>
            </ul>
        ...
        <div class="card">
          <div class="card-header p-2">
            <ul class="nav nav-pills">
              ...
              <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Modifier ma boutique</a></li>
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                <!-- Post -->
                <form class="form-horizontal" method="post" action="enregistrement/save_client_update_profile.php">
                <input type="hidden" name="id" value="<?php echo $vueClient['utilisateur_id']; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="nom" value="<?php echo $vueClient['utilisateur_nom']; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Prenoms</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail" name="prenoms" value="<?php echo $vueClient['utilisateur_prenoms']; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputName2" class="col-sm-2 col-form-label">Contact</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName2" name="contact" value="<?php echo $vueClient['utilisateur_contact']; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                  </div>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" method="post" action="enregistrement/save_client_update_password.php">
                <input type="hidden" name="id" value="<?php echo $vueClient['utilisateur_id']; ?>">
