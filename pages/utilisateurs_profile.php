...
<body>
                            ...
                            <div class="form-modern">
                                ...
                                <form method="post" action="enregistrement/save_utilisateur_update_password.php" id="passwordForm">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-4">
                                        <button type="button" class="btn btn-warning" onclick="directResetPassword()" title="Réinitialiser au mot de passe par défaut">
                                            <i class="fas fa-undo me-2"></i>Réinitialiser le mot de passe
                                        </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 15px 35px rgba(0, 0, 0, 0.15);">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <p class="text-muted">Votre mot de passe a été mis à jour. Vous allez être redirigé vers la liste des utilisateurs.</p>
                </div>
                <div class="modal-footer justify-content-center" style="border: none;">
                    <button type="button" class="btn btn-success px-4" onclick="redirectToUsers()">
    ...
    <script>
        ...
        // Direct password reset without confirmation modal
        function directResetPassword() {
            const userId = <?php echo $vueUtilisateur['id']; ?>;
            const resetBtn = document.querySelector('button[onclick="directResetPassword()"]');
            const originalText = resetBtn.innerHTML;
            
            // Show loading state
            resetBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Réinitialisation...';
            resetBtn.disabled = true;
            
            // Send AJAX request to reset password
            fetch('enregistrement/reset_password_default.php', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.querySelector('#successModal h4').textContent = 'Mot de passe réinitialisé !';
                    document.querySelector('#successModal .text-muted').textContent = 'Le mot de passe a été réinitialisé à "Unipalm@@2020". Vous allez être redirigé vers la liste des utilisateurs.';
                    successModal.show();
                    ...
                    alert('Erreur lors de la réinitialisation du mot de passe: ' + data.message);
