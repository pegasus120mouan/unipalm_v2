...
$where_conditions[] = "d.date_approbation IS NOT NULL";
...
// Demande Validées
$demandes_validees = "SELECT * FROM demande_sortie WHERE date_approbation IS NOT NULL";
$stmt = $conn->prepare($demandes_validees);
$stmt->execute();
$demandes_validees = $stmt->fetchAll(PDO::FETCH_ASSOC);
$total_demandes_validees = count($demandes_validees);
...
<div class="row">
    ...
    <div class="block-container">
        <div class="d-flex justify-content-between align-items-center">
            <h3><i class="fa fa-check-circle text-success"></i> Liste des Demandes Validées</h3>
            <div class="text-muted">
                <?php echo $total_demandes_validees; ?> demande(s) validé(s)
            </div>
        </div>
    </div>
</div>
